  ...
  <div>
    <div class="Toolbar">
      ...
      <div class="Buttons">
        ...
        <base-tooltip content="Open a file using a server round-trip">
          <base-icon-button>
            <svg v-if="!graphListIsActive"
            @click="toSelectNewGraph" width="18" height="16" viewBox="0 0 18 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-else @click="graphListIsActive = false" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <base-tooltip content="Open the graph that was saved to the 'Storage'">
        ...
        <base-tooltip content="Save to the 'Storage'">
